                    ...
                    <div className="lg:col-span-5 space-y-8">
                        ...
                        <div className="rounded-2xl bg-gray-50 border border-gray-100 p-6">
                            ...
                            <ol className="space-y-3">
                                {[
                                    `Click "Go to ${storeName}" above to shop`,
                        ...
                        <div className="rounded-2xl bg-gray-50 border border-gray-100 p-6">
                            ...
                            <div className="space-y-5">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500" suppressHydrationWarning>Yes — our team verified this code on {new Date(coupon.updated_at || Date.now()).toLocaleDateString("en-US", { month: "long", day: "numeric", year: "numeric" })}. It is currently active and working.</p>
                                </div>
                                <div>
