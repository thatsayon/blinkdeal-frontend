...
// Static demo data — Amazon coupon
const coupon = {
    store: "Amazon",
    storeSlug: "amazon",
    color: "bg-orange-50 text-orange-600",
    title: "Flat $50 OFF on Electronics",
    description: "Save a flat $50 on electronics purchases of $200 or more. Works on laptops, tablets, cameras, and smart home devices. One use per account.",
    code: "TECH50",
    discount: "$50 OFF",
    verified: true,
    expiry: "Ends today",
    ...
    storeDescription: "Amazon is the world's largest online marketplace. From electronics to everyday essentials, Amazon offers tens of millions of products with fast Prime shipping.",
};

export default function CouponDetailPreview() {
    ...
    return (
        <main className="min-h-screen bg-white pb-24">
            {/* Preview Banner */}
            <div className="bg-blue-600 text-white text-center py-2.5 text-xs font-bold tracking-wide">
                DESIGN PREVIEW — This is how a coupon detail page looks
            </div>
            ...
            <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
                ...
                <nav className="flex items-center gap-2 text-xs font-medium text-gray-400 mb-10" aria-label="Breadcrumb">
                    ...
                    <ChevronRight size={14} />
                    <span className="text-gray-600 font-bold">{coupon.store}</span>
                </nav>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
                    ...
                    <div className="lg:col-span-7 space-y-10">
                        ...
                        {/* Hero */}
                        <div>
                            <div className={`inline-flex h-16 w-16 items-center justify-center rounded-2xl ${coupon.color} font-black text-3xl uppercase mb-5`}>
                        ...
                        <div className="rounded-2xl border-2 border-gray-900 p-6 sm:p-8 bg-white">
                            <p className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-4">Your Promo Code</p>
                            <div className="flex items-center gap-4">
                                <div className="flex-1 rounded-xl border border-dashed border-gray-300 bg-gray-50 px-5 py-4 font-mono text-2xl sm:text-3xl font-black text-gray-900 tracking-widest text-center select-all">
                                    {coupon.code}
                                </div>
                                <button
                                    onClick={handleCopy}
                    ...
                    <div className="lg:col-span-5 space-y-8">
                        ...
                        <div className="rounded-2xl bg-gray-50 border border-gray-100 p-6">
                            <h2 className="text-base font-bold text-gray-900 mb-3">About {coupon.store}</h2>
                            <p className="text-sm text-gray-500 leading-relaxed">{coupon.storeDescription}</p>
                            <a
                                href={coupon.storeUrl}
                                target="_blank"
                                rel="noopener noreferrer"
                        ...
                        <div className="rounded-2xl bg-gray-50 border border-gray-100 p-6">
                            ...
                            <ol className="space-y-3">
                                {[
                                    `Click "Go to ${coupon.store}" above to shop`,
                                    "Add your favorite items to the cart",
                                    `Enter code "${coupon.code}" at checkout`,
                                    "Your discount is applied instantly",
                                ].map((step, i) => (
                        ...
                        <div className="rounded-2xl bg-gray-50 border border-gray-100 p-6">
                            ...
                            <div className="space-y-5">
                                <div>
                                    <h3 className="text-sm font-bold text-gray-800 mb-1">Is the code <span className="font-mono bg-gray-100 px-1 rounded">{coupon.code}</span> working?</h3>
                                    <p className="text-sm text-gray-500">Yes — our team verified this code on {new Date().toLocaleDateString("en-US", { month: "long", day: "numeric", year: "numeric" })}. It is currently active and working.</p>
                                </div>
                                <div>
                                    <h3 className="text-sm font-bold text-gray-800 mb-1">When does this offer expire?</h3>
                                    <p className="text-sm text-gray-500">This offer expires soon — {coupon.expiry}. We recommend using it as soon as possible.</p>
                                </div>
                                <div>
                                    <h3 className="text-sm font-bold text-gray-800 mb-1">Can I stack this with other coupons?</h3>
                                    <p className="text-sm text-gray-500">Most stores allow one promo code per order. Check {coupon.store}'s checkout page for stacking eligibility.</p>
                                </div>
                            </div>
                        </div>
